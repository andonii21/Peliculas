 ...
 */
class noticias extends \uni\Bundle\PeliculasBundle\Entity\noticias implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'uni\\Bundle\\PeliculasBundle\\Entity\\noticias' . "\0" . 'id', '' . "\0" . 'uni\\Bundle\\PeliculasBundle\\Entity\\noticias' . "\0" . 'titulo', '' . "\0" . 'uni\\Bundle\\PeliculasBundle\\Entity\\noticias' . "\0" . 'descripcion', '' . "\0" . 'uni\\Bundle\\PeliculasBundle\\Entity\\noticias' . "\0" . 'foto', '' . "\0" . 'uni\\Bundle\\PeliculasBundle\\Entity\\noticias' . "\0" . 'fecha', 'categoria', 'peliculass');
        }
